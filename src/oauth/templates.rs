//! OAuth Web HTML Templates

/// Select authentication method page
...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .idc-form.show, .manual-form.show { display: block; }
        .form-group {
            margin-bottom: 15px;
        }
        .form-group label {
    ...
    <div class="container">
        ...
        <div class="idc-form" id="idcForm">
            <form action="/v0/oauth/kiro/start" method="get">
                ...
                <button type="submit" class="submit-btn">Continue with IDC</button>
            </form>
        </div>
        ...
        <div class="manual-form" id="manualForm">
            <form id="importForm" onsubmit="submitImport(event)">
                ...
                <button type="submit" class="submit-btn" id="importBtn">Import Token</button>
        ...
        async function submitImport(event) {
            ...
            try {
                ...
                if (response.ok && data.success) {
                    ...
                    statusEl.textContent = 'Token imported successfully! ' + (data.fileName ? 'File: ' + data.fileName : '');
                } else {
                    statusEl.className = 'status-message error';
...
/// Device code authentication start page
pub const START_PAGE_HTML: &str = r#"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <div class="container">
        ...
        <div class="step">
            ...
            <a href="{{AUTH_URL}}" target="_blank" class="auth-btn" id="authBtn">
        ...
        <div class="step">
            ...
            <div class="user-code">
                ...
                <div class="user-code-value">{{USER_CODE}}</div>
            </div>
        </div>
        ...
        <div class="status status-pending" id="statusBox">
            ...
            <div class="timer" id="timer">{{EXPIRES_IN}}s</div>
...
/// Success page
pub const SUCCESS_PAGE_HTML: &str = r#"<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body>
    <div class="success">
        ...
        <div class="expires">Token expires: {{EXPIRES_AT}}</div>
    </div>
</body>
</html>"#;
...
<body>
    <div class="error">
        ...
        <a href="/v0/oauth/kiro" class="retry-btn">Retry</a>
    </div>
</body>
</html>"#;

/// Render start page with values
...
/// Render success page with values
pub fn render_success_page(expires_at: &str) -> String {
    SUCCESS_PAGE_HTML.replace("{{EXPIRES_AT}}", expires_at)
}

/// Render error page with values
pub fn render_error_page(error: &str) -> String {
    ERROR_PAGE_HTML.replace("{{ERROR}}", &html_escape(error))
}
